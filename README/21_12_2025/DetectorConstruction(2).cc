...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    // ═══════════════════════════════════════════════════════════════════
    // Dimensions : 10 cm × 10 cm × 18 mm
    // Face avant : z = 3.75 cm
    // Centre global : z = 4.65 cm
    // Face arrière : z = 5.55 cm
    //
    // La cavité d'air (50×50 mm², hauteur ~8.53 mm) est centrée dans la plaque
    // et contient l'empilement de 5 plans de billes de bismuth
    // ═══════════════════════════════════════════════════════════════════
    ...
    // Position Z de la base de l'empilement (relative au centre de la cavité)
    // La cavité est centrée en z=0 (dans son repère local)
    // La base de l'empilement est à z = -fCaviteZ/2
    G4double empilement_base_z = -fCaviteZ/2;
    
    G4int nombreBilles = CreateBillesEmpilement(
        logicCavite,        // Volume mère = cavité d'air
        fBismuth,           // Matériau = bismuth solide
        fCaviteX,           // Dimension X du container
        fCaviteY,           // Dimension Y du container
        empilement_base_z   // Position Z de la base
    );
    ...
    G4cout << "| * Face arriere       : z = " << plaque_back_z/cm << " cm                              |" << G4endl;
